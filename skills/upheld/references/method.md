...
<!-- Source commit: 9f3e06f5b9ea9d53d1e48860e318068b9df8d978; SHA-256: a03ad586ed0cbac902cf4f9282cea7996086084f6c1483f53ef63bda8f7f6c05 -->
...
O7 and O8 remain proposed mechanisms without product execution evidence. Their wire fields replace the old promise-level `satisfied_by` and `status`. [The schema mapping](https://github.com/yzm1/upheld/blob/9f3e06f5b9ea9d53d1e48860e318068b9df8d978/docs/SCHEMA.md) preserves legacy survey notes.
...
[The compatibility table](https://github.com/yzm1/upheld/blob/9f3e06f5b9ea9d53d1e48860e318068b9df8d978/docs/SCHEMA.md) names the accepted oracle families. Gaps are decisions, and warnings alone do not establish acceptance.
...
The survey aims to discover useful new promises and defects within the time people can spend reviewing them. The checker aims to minimize silently stale assertions within that capacity. [The survey objective](https://github.com/yzm1/upheld/blob/9f3e06f5b9ea9d53d1e48860e318068b9df8d978/docs/SURVEY_TOOL.md) defines useful, new, confirmed, and decision-required outcomes. Count distinct findings and all human review work; audit omitted sources and low-ranked candidates. [The milestone](https://github.com/yzm1/upheld/blob/9f3e06f5b9ea9d53d1e48860e318068b9df8d978/docs/MILESTONE.md) defines the first measurements.
